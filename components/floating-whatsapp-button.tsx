...
export function FloatingWhatsAppButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 right-5 md:bottom-8 md:right-8 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-2xl hover:shadow-[#25D366]/50 transition-all hover:scale-110 flex items-center justify-center group"
    >
