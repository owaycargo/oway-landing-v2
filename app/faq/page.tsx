      ...
      questions: [
        {
          ...
          a: "Вы совершаете покупку в американском интернет-магазине и указываете наш склад в США в качестве адреса доставки. После получения товара мы отправляем его в выбранную вами страну. В Кыргызстан, Казахстан и Узбекистан — 7–9 дней, в Россию и Беларусь — 16–21 день.",
        },
        {
          q: "Какие страны вы обслуживаете?",
          a: "Мы доставляем в 5 стран: Россия, Беларусь, Кыргызстан, Казахстан и Узбекистан. География постоянно расширяется — следите за обновлениями на нашем сайте.",
        },
        {
        ...
        },
        {
          ...
          a: "Стоимость зависит от веса, габаритов и страны назначения. Используйте наш калькулятор на главной странице для точного расчёта. Тарифы: от $12/кг для Кыргызстана, Казахстана и Узбекистана; от $18/кг для России и Беларуси. Без минимального веса.",
        },
      ],
    },
    {
