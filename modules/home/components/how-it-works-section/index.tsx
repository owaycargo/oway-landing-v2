...
const steps = [
  ...
  },
  {
    ...
    description: "Посылка прибывает в страну получателя (Россия, Беларусь, Кыргызстан, Казахстан, Узбекистан) и передаётся на локальную доставку. Вы можете забрать в офисе, получить через курьерскую службу или выбрать пункт выдачи (СДЭК и партнёры). Отслеживание доступно в реальном времени.",
  },
]
  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto px-4 py-16 md:py-24">
      <div className="text-center mb-12 flex flex-col items-center">
        <img
          src="/mascots/mascot-thinking.webp"
          alt=""
          aria-hidden
