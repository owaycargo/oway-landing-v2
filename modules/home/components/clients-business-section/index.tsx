    ...
    <section className="w-full max-w-[1440px] mx-auto px-4 py-16 md:py-24 bg-slate-50">
      ...
      <Tabs defaultValue="clients" className="max-w-5xl mx-auto">
        ...
        <TabsContent value="clients">
          <p className="text-center text-slate-600 mb-6 text-sm md:text-base">Для личных покупок и отправок между США и странами СНГ</p>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 rounded-3xl border-slate-200">
              ...
              <p className="text-sm md:text-base text-slate-600">Заказывайте товары из американских интернет-магазинов и брендов. Мы принимаем, проверяем и отправляем ваши заказы в страны СНГ.</p>
            </Card>
            <Card className="p-6 rounded-3xl border-slate-200">
              <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center mb-4">
              ...
              <p className="text-sm md:text-base text-slate-600">Отправляйте личные вещи, подарки и посылки родным и близким из США в страны СНГ — быстро и надёжно.</p>
            </Card>
            <Card className="p-6 rounded-3xl border-slate-200">
              <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center mb-4">
              ...
              <p className="text-sm md:text-base text-slate-600">Отслеживайте статус посылки на каждом этапе доставки в личном кабинете.</p>
            </Card>
          </div>
        </TabsContent>

        <TabsContent value="business">
          <p className="text-center text-slate-600 mb-6 text-sm md:text-base">Для байеров, продавцов и компаний, работающих с США и СНГ</p>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 rounded-3xl border-slate-200">
              ...
              <p className="text-sm md:text-base text-slate-600">Вы находитесь в США и отправляете товары своим клиентам в страны СНГ. Мы берём на себя логистику, консолидацию и доставку.</p>
            </Card>
            <Card className="p-6 rounded-3xl border-slate-200">
              <div className="w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center mb-4">
              ...
              <p className="text-sm md:text-base text-slate-600">Вы находитесь в СНГ и заказываете товары из США для своих покупателей. OWAY Cargo — ваш логистический партнёр в Америке.</p>
            </Card>
            <Card className="p-6 rounded-3xl border-slate-200">
              <div className="w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center mb-4">
              ...
              <p className="text-sm md:text-base text-slate-600">Гибкие условия, регулярные отправки, работа с объёмами и поддержка бизнеса на всех этапах.</p>
            </Card>
          </div>
        </TabsContent>
      </Tabs>
